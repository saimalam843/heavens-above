...
const compare = [
    function(a, b) {
        return a[property[6]][1] >= b[property[6]][1] ? 1 : -1; // The lower the brightness, the better
    },
    function(a, b) {
        return a[property[6]][2] >= b[property[6]][2] ? 1 : -1; // The lower the sun altitude, the better
    },
    function(a, b) {
        return a[property[6]][3] <= b[property[6]][3] ? 1 : -1; // The higher the satellite altitude, the better
    },
    function(a, b) {
        return a[property[7]] <= b[property[7]] ? 1 : -1; // The longer the duration, the better
    }
];
